...
work_dir = ".\\"
# work_dir = r"C:\Users\DominiqueFournier\Dropbox\Projects\Synthetic\Block_Gaussian_topo\GRAV"
inpfile = 'DF1_Unconstr_GravInv_input_13x12x3km.inp'
dsep = os.path.sep
...
octreeObs = [10, 10, 10]  # Octree levels below observation points
octreeObs_XY = [10, 3, 3]  # Octree levels around observation points
octreeTopo = [0, 1]
ndv = -100
meshType = 'TREE'
tileProblem = True
...
if meshType != meshInput._meshType:
    ...
    mesh = Utils.modelutils.refineTree(
        mesh, rxLoc, dtype='point',
        octreeLevels=octreeObs, finalize=True
    )
...
if tileProblem:
    ...
    while usedRAM > maxRAM:
        ...
        meshLocal = Utils.modelutils.refineTree(
            meshLocal, rxLoc[ind_t, :], dtype='point',
            octreeLevels=octreeObs, finalize=True
        )
